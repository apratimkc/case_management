...
# openai.api_key = config('OPENAI_API_KEY') # This line was removed as it's not used in the new snippet
...
def extract_case_no(text_in: schemas.TextIn):
    ...
    try:
        ...
        # The prompt is defined as a template. Curly braces for JSON are escaped by doubling them.
